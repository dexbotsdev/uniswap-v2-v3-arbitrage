...
type FlashswapPayloadBytes struct {
	...
	OwnerTransferBoolAndCoinbaseTransferBoolAndV2SwapDataLengthAndTokensLengthBytes []byte //1;1;3;3 bits
	...
	BribeBytes []byte //IntByteSize bytes //only if coinBaseTransferBool is true
...
func convertPathExecutionValuesToFlashswapPayloadBytes(pathExecutionValues PathExecutionValues) (FlashswapPayloadBytes, error) {
	...
	//OwnerTransferBoolAndCoinbaseTransferBoolAndV2SwapDataLengthAndTokensLengthBytes []byte //1;1;3;3 bits
	ownerTransferBoolAndCoinbaseTransferBoolAndV2SwapDataLengthAndTokensLengthValue := 0
	if pathExecutionValues.OwnerTransferBool {
		ownerTransferBoolAndCoinbaseTransferBoolAndV2SwapDataLengthAndTokensLengthValue += 128
	}
	if pathExecutionValues.CoinBaseTransferBool {
		ownerTransferBoolAndCoinbaseTransferBoolAndV2SwapDataLengthAndTokensLengthValue += 64
	}
	ownerTransferBoolAndCoinbaseTransferBoolAndV2SwapDataLengthAndTokensLengthValue += pathExecutionValues.V2SwapDataLength*8 + pathExecutionValues.TokensLength
	ownerTransferBoolAndCoinbaseTransferBoolAndV2SwapDataLengthAndTokensLengthBytes := []byte{byte(ownerTransferBoolAndCoinbaseTransferBoolAndV2SwapDataLengthAndTokensLengthValue)}
	...
	bribeBytes := []byte{}
	if pathExecutionValues.CoinBaseTransferBool {
		bribeBytes = padBytes(pathExecutionValues.Bribe.Bytes(), intByteSize)
	}
	...
	flashswapPayloadBytes := FlashswapPayloadBytes{
		...
		OwnerTransferBoolAndCoinbaseTransferBoolAndV2SwapDataLengthAndTokensLengthBytes: ownerTransferBoolAndCoinbaseTransferBoolAndV2SwapDataLengthAndTokensLengthBytes,
...
func printFlashswapPayloadBytes(flashswapPayloadBytes FlashswapPayloadBytes) {
	...
	fmt.Println("OwnerTransferBoolAndCoinbaseTransferBoolAndV2SwapDataLengthAndTokensLengthBytes:", hex.EncodeToString(flashswapPayloadBytes.OwnerTransferBoolAndCoinbaseTransferBoolAndV2SwapDataLengthAndTokensLengthBytes))
	...
	fmt.Println("BribeBytes:", hex.EncodeToString(flashswapPayloadBytes.BribeBytes))
	// type V2SwapDataBytes struct {
...
func appendFlashswapPayloadBytesToBytesArray(flashswapPayloadBytes FlashswapPayloadBytes) []byte {
	...
	bytesArray = append(bytesArray, flashswapPayloadBytes.OwnerTransferBoolAndCoinbaseTransferBoolAndV2SwapDataLengthAndTokensLengthBytes...)
	...
	bytesArray = append(bytesArray, flashswapPayloadBytes.BribeBytes...)
	for _, v2SwapDataBytes := range flashswapPayloadBytes.V2SwapDataBytesArr {
